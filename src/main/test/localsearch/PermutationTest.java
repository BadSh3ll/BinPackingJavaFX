...
@DisplayName("Permutation-based Local Search Test")
class PermutationTest {
    ...
    private static LocalSearchSolver<PermutationSolution> localSearchSolver;
    ...
    void easy() {
        ...
        for (Instance instance : easyInstances) {
            ...
            PermutationSolution permutationSolution = localSearchSolver.solve(initial);
