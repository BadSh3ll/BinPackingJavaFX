...
@DisplayName("First Fit Decreasing Area with BottomLeft Putting Strategy Test")
class FirstFitAreaBottomLeftTest {
    ...
    void easy() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "FirstFitAreaBottomLeft_EasyResults.csv"
        );
    ...
    void medium() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "FirstFitAreaBottomLeft_MediumResults.csv"
        );
    ...
    void hard() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "FirstFitAreaBottomLeft_HardResults.csv"
        );
