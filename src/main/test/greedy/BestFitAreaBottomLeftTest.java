...
@DisplayName("Best Fit Decreasing Area with BottomLeft Putting Strategy Test")
class BestFitAreaBottomLeftTest {
    ...
    void easy() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "BestFitAreaBottomLeft_EasyResults.csv"
        );
    ...
    void medium() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "BestFitAreaBottomLeft_MediumResults.csv"
        );
    ...
    void hard() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "BestFitAreaBottomLeft_HardResults.csv"
        );
