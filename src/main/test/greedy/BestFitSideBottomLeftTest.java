...
@DisplayName("Best Fit Decreasing Side with BottomLeft Putting Strategy Test")
class BestFitSideBottomLeftTest {
    ...
    void easy() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "BestFitSideBottomLeft_EasyResults.csv"
        );
    ...
    void medium() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "BestFitSideBottomLeft_MediumResults.csv"
        );
    ...
    void hard() {
        ...
        Path path = Paths.get(
                ...
                "csv",
                "greedy",
                "BestFitSideBottomLeft_HardResults.csv"
        );
